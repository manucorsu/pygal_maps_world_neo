...
- ⚠️ **Migrated from setup.py to Hatchling**. This also includes dropping Python 2 support which pygal did a long time ago but was de jure still supported by this package's setup.py. The minimum supported Python version is now 3.10 until its EOL.
